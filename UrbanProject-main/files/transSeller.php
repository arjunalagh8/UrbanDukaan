...
<?php
	...
	$stmt0 = $conn->query("SELECT name,balance FROM urbandukan_project.seller where sid = $sid;");
...
<body>
	...
	<?php
	$i=1;
	$stmt = $conn->query("SELECT pid,cid,proName,shopName,trans_time,price FROM urbandukan_project.transaction where sid = $sid;");
