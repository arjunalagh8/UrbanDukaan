...
<?php
	...
	$stmt0 = $conn->query("SELECT shopName,shopCategory FROM urbandukan_project.shop where shopId = $shopid;");
...
<body>
  ...
  <div class="site-pusher">
    ...
    <header class="header">
      ...
      <a href="#" class="header__logo__Pc nonClick">UrbanDukaan</a>
      <a href="#" class="header__logo__Mob nonClick ">UrbanDukaan</a>
...
<?php
	$image="";
		$dir = 'uploads'; 
		$stmti = $conn->query("SELECT img1 FROM urbandukan_project.shopimage where shopId = $shopid;");
...
<?php
	$image="";
	$dir = 'uploads'; 
	$stmt = $conn->query("SELECT productName,pid,img1,img2,img3,price FROM urbandukan_project.product where shopId = $shopid;");
