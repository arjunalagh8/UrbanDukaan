<?php
	...
	session_start();
	$cid = $_SESSION['NavCid'];
	$stmt0 = $conn->query("SELECT name,email,contactNo FROM urbandukan_project.customer where cid = $cid;");
	$stmt1 = $conn->query("SELECT pri_add,home_add,work_add FROM urbandukan_project.customer_address where cid = $cid;");
